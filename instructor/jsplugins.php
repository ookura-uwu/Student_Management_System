    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            //     $('#editSYModalLocation').addClass('modal-dialog-centered');
            //     $('#errorLocation').addClass('modal-dialog-centered');
            //     $('#confirmLocation').addClass('modal-dialog-centered');

            //     document.getElementById('grade_action').style.display = 'none';
